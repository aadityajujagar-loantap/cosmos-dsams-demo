    ...
    .flatMap((dsa, dsaIndex) =>
      products.slice(0, 3 + (dsaIndex % 2)).map((product, productIndex) => {
        ...
        return {
          ...
          ranges: [
            {
              commissionAmount: 6000 + dsaIndex * 250 + productIndex * 750,
              ...
              max: 2500000,
              min: 0,
              rate: 0.75 + productIndex * 0.15,
            },
            {
              commissionAmount: 18000 + dsaIndex * 500 + productIndex * 1200,
              effectiveDate: "2026-04-01",
              endDate: "2027-03-31",
              frequency: "Monthly",
              growthRequired: true,
